...
router.post('/', async (req, res) => {
    ...
    try {
      ...
      const itemResult = await pool.query('SELECT * FROM maleItems WHERE product_id = $1', [product_id]);
      ...
      // Create relationship
      await pool.query('INSERT INTO favorite_male (user_id, product_id) VALUES ($1, $2)', [user_id, product_id]);
